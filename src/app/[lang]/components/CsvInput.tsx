              ...
              bgcolor="secondary.main">
      {
        (isSubmitted && !isError ) &&  
                      <Alert
                        ...
                        sx={{marginTop:4}}
                        >
                        { dictionary ? dictionary.csvUploadComponent.successMessage  : ''}
                      </Alert> 
      }
      {            
        isError && <Alert severity="error"
                      action={
                        ...
                        sx={{marginTop:4}}
                        >
                        { dictionary ? dictionary.csvUploadComponent.errorMessage : '' }
                      </Alert>
      }
      <Box sx={{ display: 'flex', 
        ...
        <Box sx={{ display: 'flex', 
          ...
          <Typography variant='body1' 
                      ...
                      color='black' 
                      marginBottom={1}>
            <strong>{ dictionary ? dictionary.csvUploadComponent.supportedFiles : '' }</strong>
          </Typography>
